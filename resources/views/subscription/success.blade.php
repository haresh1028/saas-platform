        ...
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600 mb-8">
                    ...
                    {{ $subscription->plan->name }} features.
                </p>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8 text-left">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium text-gray-900">${{ number_format($subscription->plan->price, 2) }}/{{ $subscription->plan->billing_cycle }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium text-gray-900">{{ $subscription->next_billing_date->format('M d, Y') }}</span>
                        </div>
                ...
                <div class="space-y-4">
                    <a href="{{ route('admin.dashboard') }}"
                        class="w-full flex justify-center py-3 px-6 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        Go to Dashboard
                    </a>
